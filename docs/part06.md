...
And that's the end of part 6! You can now move on to [Part 7 - Welcome](./part07.md), or you can take a [look at the full code for this part.](https://github.com/vcokltfre/bot-tutorial/tree/master/code/part6)
